...
public class CF_Red_2nd_Auto extends OpMode
{
   ...
   CF_Red_Vuforia.checks Check = CF_Red_Vuforia.checks.GRABBLOCK;
   ...
   public void loop()
   {
      switch (Check)
      {
         ...
         case GRABBLOCK:
            ...
            checkTime();
            Check = CF_Red_Vuforia.checks.JEWELHITTER;
         ...
         case JEWELHITTER:
            ...
            robot.armUp(1.0);
            checkTime();
            Check = CF_Red_Vuforia.checks.MOVEMAST;
            break;
      }
   }