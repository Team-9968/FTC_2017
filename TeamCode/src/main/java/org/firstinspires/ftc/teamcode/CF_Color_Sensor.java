...

{
   ...
   public CF_Color_Enum getColorValues(CF_Hardware robot)   //Sensor on Left side of bot when viewed from the side opposite of the whale tail
   {
   ...
   public CF_SecondSensorEnum getWiffleBallValues(CF_Hardware robot)  //Sensor is  RIGHT when viewed from the side opposite the whale tail
   {
      // convert the RGB values to HSV values.
