...
@Autonomous(name = "Blue Aim CC", group = "Sensor")
//@Disabled
public class CF_Blue_Aim_CC extends OpMode
{
...
//         }
         ...
         case PASTBALANCE:
            auto.EncoderIMUDrive(this, robot, CF_Autonomous_Motor_Library.mode.DRIVE, -0.2f, 1300);
